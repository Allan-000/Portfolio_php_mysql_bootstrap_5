...
//employees display box
const displayBoxToggler=document.querySelector(".display-box-toggler");
const displayBox=document.querySelector("#display-box");
displayBoxToggler.addEventListener("click",()=>{
    displayBox.classList.toggle("display-box-disactive")
})